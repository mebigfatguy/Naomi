...
/**
 * This Enum defines a set of constants, each of which specifies a pre-defined "Core" set of characters to be matched (as described below). Each of these Enum
 ...
 * </pre>
 *
 * matches (on each repetition) any single character that is not a line terminator.
 *
 */
...
public enum CoreBuiltIn implements BuiltInInterface {
    ...
    white("\\s"),
    /** A non_whitespace character */
    notWhite("\\S"),
    /** A word character */
    word("\\w"),
    /** A non_word character */
    nonWord("\\W"),
    /**
     * A line feed, a carriage return ,or a carriage return followed immediately by a linefeed
     */
    lineEnd("(\\r\\n)|(\\n)|(\\r)"),
    ...
    /** A lower_case alphabetic character */
    lower("\\p{Lower}"),
    /** An upper_case alphabetic character */
    upper("\\p{Upper}"),
    /** All ASCII */
    ascii("\\p{ASCII}"),
    /** An alphabetic character */
    alpha("\\p{Alpha}"), alphnumeric("\\p{Alnum}"), // An alphanumeric character:[\\p{Alpha}\\p{Digit}]
    /** Punctuation */
    punct("\\p{Punct}"),
    /** A visible character */
    visible("\\p{Graph}"),
