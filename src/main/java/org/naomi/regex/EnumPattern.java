...
/**
 *
 * An instance of EnumPattern matches, on each repetition, any of the strings corresponding to the constants of the {@link Enum} used to instantiate the
 * EnumPattern.
 * <p>
 *
 * Note that this is quite different from {@link BuiltInCharClass}, which uses the constants defined by BuiltIn Enums as the names of sets of characters. In
 * contrast, an EnumPattern matches its instantiating Enum's constant values themselves, as string literals.
 *
 * <p>
 * Example:
 *
 ...
 * };
 *
 * EnumPattern compassPattern = new EnumPattern(compass.class); // Note: need ".class" here
 * </pre>
 *
...
public class EnumPattern extends OrPattern {
    ...
    /**
     *
     * Returns the first constant of the Enum whose toString()constant of the Enum is case independently equal to string, or null, if none.
     *
    ...
    /**
     *
     * Returns the first constant of the Enum whose toString() is matched by pattern or null, if none.
     *
     * @throws ReuseException
     *
     */
    ...
    /**
     * Returns the first constant of the Enum whose toString() is case independently equal to matcher.group(this)) or null, if none.
     *
     * @throws ReuseException
     */
    ...
    /**
     *
     * Returns the zero based ordinal of the first constant of the Enum whose toString() constant of the Enum is case independently equal to matcher.group(this)
     * or null, if none.
     *
     */
    ...
    /**
     * return a list of all constants in which string is initial. Returned list is empty if no matches
     */
    public List<Enum<?>> getInitialMatches(String string, boolean insensitive) {
        if (insensitive) {
